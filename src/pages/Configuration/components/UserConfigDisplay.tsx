 ...
 * @LastEditTime: 2024-11-01 13:39:08
...
import { Card, Descriptions, Divider, Tag, Typography, Watermark } from 'antd';
    ...
    <Watermark content={currentUser?.name}>
      <Card style={{ margin: 20 }}>
        <Descriptions
          title={
            <FormattedMessage
              id="pages.trainingConfig.basicInformation"
              defaultMessage="基本資訊"
            />
          }
          bordered
        ...
        >
          ...
          <Descriptions.Item
            label={
              <FormattedMessage
                id="pages.trainingConfig.frameworkName"
