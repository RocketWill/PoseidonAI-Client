...
const Dataset: React.FC = () => {
  ...
  const handleDisplayVisDatasetChildren = (dataset: any, visualizedFiles: string[]) => {
      ...
      },
      {
        ...
        label: (
          <>
            ...
            {handleDisplayVisDatasetLabel(datasetId, dataset.image_files, visualizedFiles)}
          </>
        ),
        ...
        >
          <Spin spinning={uploadLoading}>
            ...
            >
              ...
              <Form.Item
                label={
                  <FormattedMessage id="pages.dataset.display.description" defaultMessage="描述" />
                }
                name="description"
              >
                <Input />
